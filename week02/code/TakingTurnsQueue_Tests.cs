...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: You should only not enqueue if Turns == 1. Currently, only Turns > 1 was being handled. Also the PersonQueue was using Insert intead of Add.
    ...
    // Defect(s) Found: Same as above, people with 1 turn were not handled correctly and inserted the new person at the front of the list.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There was no handling of 0 in queue. 
    ...
    // Defect(s) Found: Same as above. Negative Turns are infinite but were not handled.
