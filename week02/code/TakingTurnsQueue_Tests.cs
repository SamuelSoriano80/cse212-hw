...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: You should only not enqueue if Turns == 1. Currently, only Turns > 1 was being handled.
    ...
    // Defect(s) Found: Same as above, people with 1 turn were not handled correctly.
